...
class World:
    def __init__(self, args):
        ...
        self.text_params = font.render("Testing fonts", True, pygame.Color("white"))
        ...
        self.text_params = [
            ...
            font.render(
                "almost_perfect_alpha = {}".format(self.args.alpha),
                True,
                pygame.Color("white"),
            ),
        ]
    ...
    def qlearning(self):
        ...
        for train_ep in range(1, self.args.train_episodes + 1):
            ...
            while not self.is_final_state(state, num_iter):
                ...
                Q[(my_state, action_agent)] = (1 - alpha) * Q.get(
                    (my_state, action_agent), 0
